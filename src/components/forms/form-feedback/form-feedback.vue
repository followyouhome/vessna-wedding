  ...
  <v-form @success="success" @failure="failure">
    ...
    <template slot='body'>
      <div class="form-feedback__group">
        ...
        <div class="row my-4">
          ...
          <div class="col col-4 col-sm-12 my-1">
            <atom-input class="form__input-text" v-model="form.email" type="text" placeholder="E-mail" required/>
          </div>
          <div class="col col-4 col-sm-12 my-1">
            <atom-input class="form__input-text" v-model="form.phone" type="text" placeholder="Телефон" required/>
          </div>
        </div>
        <div class="row mt-4 mb-4">
          <div class="col col-6 col-sm-12 my-1">
            <atom-input class="form__input-text" v-model="form.country" type="text" placeholder="Страна" required/>
          </div>
          <div class="col col-6 col-sm-12 my-1">
            <atom-input class="form__input-text" v-model="form.city" type="text" placeholder="Город" required/>
          </div>
        </div>
      </div>
      <div class="form-feedback__group">
    ...
    <template slot='footer'>
      <div class="form-feedback__control">
        ...
        <atom-checkbox class="ml-4 my-1" v-model="state.checked"  value="true" inline label="Даю согласие на обработку персональных данных"/>
      </div>
    </template>
  </v-form>
</template>
