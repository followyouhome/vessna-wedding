<template>
    ...
    <div class="promo__wrapper promo--topical__wrapper">
      <router-link class="promo__image-wrapper promo--topical__image-wrapper" v-bind:to="{ name: 'page-news', params: { news: item.slug }}">
      ...
      <div class="promo__content-wrapper promo--topical__content-wrapper">
        <router-link class="promo--topical__headline" v-bind:to="{ name: 'page-news', params: { news: item.slug }}">
